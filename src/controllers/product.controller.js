...
export const createProduct = async (req, res) => {
    ...
    try {
        const product = await managerProduct.addEmelents ([{ title,
        description, code, price, status, stock, category }])
...
export const updateProduct = async (req, res) => {
    ...
    const { title, description, code, price, status, stock, category, thumbnails
     ...
     try{
        const product = await managerProduct.updateElement(id, { title:
        title, description: description, code: code, price: price, status: status,
    stock: stock, category: category, thumbnails: thumbnails })
